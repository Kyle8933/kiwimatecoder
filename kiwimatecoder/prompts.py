...
- After changing code, run tests or builds with run_bash when it makes sense (use \
shell instead when `cd` or exported environment state must persist between commands).
