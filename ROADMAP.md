...
- [ ] 1.13 Dry-run mode (S)
- [ ] 1.14 Audit log of every tool action (S)
...
- [ ] 3.5 Memory: project + user-level persisted facts (L; depends 0.9)
...
- [ ] 4.1 Headless mode: `-p/--print`, JSON/stream-JSON, exit codes, render abstraction (L)
...
- [ ] 4.12 Embedded SDK / headless library API (M; depends 4.1)
